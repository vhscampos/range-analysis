...
A fim de determinar quais laços são alcançáveis, nós utilizamos o
...
A nossa definição de vulnerabilidade inclui muitos laços que não são, de fato,
vulneráveis, tais como aquele visto na figura~\ref{fig:fact}(c).
...
\begin{itemize}
\item os argumentos do método \texttt{main};
