...
Mostramos o tamanho absoluto do programa, em número de 
instruções e as informações sobre o seu grafo de dependências.
Em média 14\% dos valores que o programa manipula podem
conter informações vindas da entrada de dados.
Esses valores são produzidos por funções externas, para as quais não é
possível saber se há ou não acesso a dados externos.
...
A tabela também apresenta a quantidade de nós de memória.
...
Sinônimos são agrupados em um mesmo nó de memória.
