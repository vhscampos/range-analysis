...
detect overflows.
Instrumenting \textsc{Add} or \textsc{Sub} requires 12 LLVM instructions.
Left shifts need 8 instructions, \textsc{Mul} requires 7 and
\textsc{Trunc} requires only 3.
...
However, as we show empirically, this growth is not too large when compared
to the total size of our benchmarks, because most of the instructions in these
programs do not demand instrumentation.
