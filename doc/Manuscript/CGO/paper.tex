...
%Analysis about the Table 1 of the spreadsheet (Unpruned Instrumentation)
Figure~\ref{fig:unpruned_analysis} shows the number of instructions that has
received instrumentation, without avoiding inserting the instrumentation by
using any static analysis. We can see that the number of these instructions is low 
(3,96 in the average). 
Figure~\ref{fig:prunning_analysis} shows that it is possible to use static 
analysis to avoid inserting the instrumentation in some instructions.
