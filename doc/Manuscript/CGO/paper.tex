...
\hline
Program Name & \multicolumn{1}{l|}{Num. of Instructions} & \multicolumn{1}{l|}{Num. Instrumented Instructions} & \multicolumn{1}{l|}{Perc. Instrumented Instructions} & \multicolumn{1}{l|}{Num. Instructions Where Overflows Occurred} \\ \hline
...
\hline
Name & \multicolumn{1}{l|}{Num. instrumented instructions} & \multicolumn{1}{l|}{Num. instrumented instructions with e-SSA form} & \multicolumn{1}{l|}{Perc. reduction of e-SSA compared with original} & \multicolumn{1}{l|}{Num. instrumented instructions with u-SSA form} & \multicolumn{1}{l|}{Perc. reduction of u-SSA compared with original} \\ \hline
...
464.h264ref & 13.548 & 11.301 & 16,59\% & 11.342 & 16,28\% \\ \hline
...
\hline
Name & \multicolumn{1}{l|}{Number of safe instructions} & \multicolumn{1}{l|}{Number of suspicious instructions} & \multicolumn{1}{l|}{Number of uncertain instructions} & \multicolumn{1}{l|}{Number of buggy instructions} & \multicolumn{1}{l|}{Number of suspicious instructions that produced overflows} & \multicolumn{1}{l|}{Percentage of suspicious instructions that produced overflows} & \multicolumn{1}{l|}{Number of Uncertain instructions that produced overflows} & \multicolumn{1}{l|}{Percentage of Uncertain instructions that produced overflows} \\ \hline
470.lbm & 1.138 & 0 & 4 & 0 & 0 & 0,00\% & 0 & 0,00\% \\ \hline
433.milc & 536 & 17 & 1.048 & 0 & 0 & 0,00\% & 11 & 1,05\% \\ \hline
444.namd & 334 & 480 & 2.420 & 0 & 0 & 0,00\% & 12 & 0,50\% \\ \hline
447.dealII & 6.188 & 39 & 28.740 & 0 & 0 & 0,00\% & 50 & 0,17\% \\ \hline
450.soplex & 229 & 16 & 2.881 & 0 & 0 & 0,00\% & 13 & 0,45\% \\ \hline
464.h264ref & 2.539 & 1.195 & 10.147 & 0 & 7 & 0,59\% & 167 & 1,65\% \\ \hline
473.astar & 48 & 11 & 795 & 0 & 0 & 0,00\% & 0 & 0,00\% \\ \hline
458.sjeng & 150 & 213 & 1.977 & 0 & 0 & 0,00\% & 68 & 3,44\% \\ \hline
429.mcf & 1 & 0 & 164 & 0 & 0 & 0,00\% & 8 & 4,88\% \\ \hline
471.omnetpp & 659 & 25 & 1.288 & 0 & 1 & 4,00\% & 2 & 0,16\% \\ \hline
403.gcc & 3.365 & 1.045 & 14.065 & 0 & N/A & N/A & N/A & N/A \\ \hline
445.gobmk & 1.509 & 742 & 11.736 & 0 & 0 & 0,00\% & 4 & 0,03\% \\ \hline
462.libquantum & 104 & 12 & 805 & 0 & 0 & 0,00\% & 7 & 0,87\% \\ \hline
401.bzip2 & 192 & 40 & 1.926 & 0 & N/A & N/A & N/A & N/A \\ \hline
456.hmmer & 663 & 222 & 3.082 & 0 & 0 & 0,00\% & 0 & 0,00\% \\ \hline
\end{tabular}
\end{small}
\end{center}
...
\begin{figure}[t!]
\begin{center}
\includegraphics[width=\columnwidth]{images/prunningChart}
\end{center}
\caption{\label{fig:prunningChart}
Chart showing that our analysis was able to avoid inserting 24.93\%
of the instrumentations, in average.}
\end{figure}

%Analysis about the tables

%Analysis about the area chart (Amount of instrumentations pruned)


%How we have done the dynamic tests  
We have executed the instrumented programs of the integer benchmarks of SPEC
2006 CPU to measure the overhead produced by our instrumentation in 
real world programs.
To do this, we have developed a little test framework that compiles, runs and
collects the statistics about the execution of all the programs of SPEC 2006.
The execution of the programs was made using the arguments and inputs of the "test"
mode, which is faster to execute than the "ref" inputs.

\begin{figure}[t!]
\begin{center}
\includegraphics[width=\columnwidth]{images/performanceChart}
\end{center}
\caption{\label{fig:performanceChart}
Comparison between the execution times with and without prunning, 
normalized by the original program's execution time.}
\end{figure}

%Performance
Figure~\ref{fig:performanceChart} compares the execution times of the original program (baseline),
the instrumented program without avoiding to insert any instrumentation (black), and 
the instrumented program avoiding to insert the instrumentation whenever possible (gray).
We can see that the maximum overhead we have got was near 10\% in 464.h264ref, a program
that relies heavily on arithmetics instructions. 
As pointed by Dietz {\em et al.}~\cite{Dietz12}, we had some cases where surprisingly we had
a little speedup, too. Nevertheless, the fully instrumented programs had an average slowdown of 3,2\%
and the programs instrumented using the range analysis to do the prunning had an average slowdown
of 1,7\%. That results indicate that even avoiding to insert just 25\% of the overflow checks,
we still can recover almost 50\% of the overhead, because many of the 
analyzed instructions are within loops.
