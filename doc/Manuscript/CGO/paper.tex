...
\#O: number of actual overflow tests detected dynamically.}
\end{figure}
...
How the range analysis classified arithmetic instructions.
\#Sf: safe.
\#S: suspicious.
\#U: uncertain.
