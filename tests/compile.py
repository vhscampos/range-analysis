...
if checkArgs(sys.argv):
    ...
    os.system("opt -mem2reg "+fileName+".bc -o "+fileName+".bc")
    os.system("opt -internalize -inline "+fileName+".bc -o "+fileName+".bc")
    print("opt -instnamer -mem2reg -break-crit-edges "+fileName+".bc -o "+fileName+".bc")
    os.system("opt -instnamer -break-crit-edges "+fileName+".bc -o "+fileName+".bc")
